...
const Depot = () => {
  ...
  const [chooseDepot, setChooseDepot] = useState(0);

  const handleSelectionChange = (newValue) => {
    setSelectedZone(newValue);
  };

  const getChoosedDepot = (newValue) => {
    console.log("-getChoosedDepot", newValue);
    setChooseDepot(newValue);
  };
