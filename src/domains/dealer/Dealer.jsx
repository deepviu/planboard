...
<span className=" btn btn-sm w3-small text-left w3-text-red " onClick={(e) => setVisibility(!visibility)} > <i className="fa fa-lock" ></i>   Lock / Un-Lock  </span>
      ...
      <span className="  btn btn-sm w3-text-teal  w3-small " > <i className="fa fa-file-excel-o" ></i>  Export  </span>

      <span className="  btn btn-sm w3-text-teal  w3-small w3-right " > <i className="fa fa-file-excel-o" ></i>  Import Targets  </span>
      ...
      <div class="w3-row w3-row-padding w3-padding-16 w3-margin-top  w3-margin-bottom w3-white ">
        ...
        <table class="tbl_grid w3-table table-stripped w3-white table-bordered h6 w3-small">
          ...
          <tr>
            <td> 23 </td>
            <td> <input type="text" className="inp40" value={34} /> </td>
            <td> <input type="text" className="inp40" value={4} />  </td>
            <td> <input type="text" className="inp40" value={45} /> </td>
            <td> 29 (30%)   </td>
          </tr>
        </table>
        ...
        <table class="tbl_grid w3-table table-bordered h6 w3-small ">
          ...
          <tr className="w3-yellow ">
            <td colspan="2" className="w3-center w3-padding" style={{ width: "30%" }}> Month Wise </td>
          ...
          <tr>
            ...
            <td> <input type="text" className="inp40" value={4} />  </td>
            <td> <input type="text" className="inp40" value={45} /> </td>
            <td> <input type="text" className="inp40" value={12} />   </td>
          </tr>
        ...
        <table class="tbl_grid w3-table table-bordered h6 w3-small ">
          ...
          <tr className="w3-yellow ">
            <td colspan="5" className="w3-center w3-padding " style={{ width: "14%" }}> Month  Opening </td>
          ...
          <tr className="w3-light-gray w3-center" >
            ...
            <td rowspan="2" className="w3-yellow w3-padding w3-padding "> OS </td>
            <td rowspan="2" className="w3-yellow w3-padding w3-padding "> OD </td>
        ...
        <table class="tbl_grid w3-table table-bordered w3-center h6 w3-small ">
          ...
          <tr className="">
            <td className="w3-center w3-padding w3-small   " style={{ width: "20%" }} > <i> [   Anyother activity from activity master] </i>   </td>
