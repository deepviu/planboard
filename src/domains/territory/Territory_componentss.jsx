...
const Territory_Componentss = ({ depotsData, selectedDepot = "all" }) => {
  ...
  return (
    <div>
      ...
      <div class="w3-row w3-row-padding w3-padding-16 w3-margin-bottom w3-white ">
      ...
      <table class="tbl_grid w3-table table-bordered  h6 w3-small w3-white ">
        ...
        <tr className=" w3-yellow h6">
          <td colspan="1" className="" style={{ width: "14%" }}> Territory  </td>
      ...
      < CustomPopup
        ...
        Territoy Level Rules ( to Set Targets or breakdown Targets on every enity )
